...
function fy(str)
{
		...
		else
		{
			...
			xmlhttp.open("GET", "viewmobile.php?q=ac", true);
			xmlhttp.send();
		}
...
<p style="padding-top:10px">
	...
	<nav>
		<p style="padding-left:4px;background-color:#000099;color:#ffffff;font-size:20px"> Sort By Price </p>
		<div style="box-shadow: 1px 2px 2px 2px #d6d6c2;width:190px;height:100px">
		<input type='radio' name='n11' onChange='fz(this.value)' value='61'> Less than 30,000 <br>
		<input type='radio' name='n11' onChange='fz(this.value)' value='62'> Between 30,000 to 40,000 <br>
		<input type='radio' name='n11' onChange='fz(this.value)' value='63'> More than 40,000 <br>
		</div><br>
		<p style="padding-left:4px;background-color:#000099;color:#ffffff;font-size:20px"> Sort By Capacity </p>
		<div style="box-shadow: 1px 2px 2px 2px #d6d6c2;width:190px;height:50px">
		<input type='radio' name='n11' onChange='fz(this.value)' value='151'> 1 Ton <br>
		<input type='radio' name='n11' onChange='fz(this.value)' value='152'> 2 Ton <br>
		</div>
	</nav>
<article>
...
<?php
	$con=new MySQLi("localhost","root","","electronics");
	$sql="select * from ac where id between 1 and 6";
	$res=$con->query($sql);
	echo "<ul style='list-style-type:none;padding-left:15px'>";
	while($row=$res->fetch_array())
	{
		echo "<li><div class='gallery1'><a href='acspecification.php?id=$row[0]'><img src='".$row[3]."'><div class='desc1'><p style='font-weight:900;font-size:14px'>".$row[1]."</p><p style='color:#006600;font-weight:600;font-size:12px'><strike>&#8377;".$row[9]."</strike></p><p style='font-weight:600;font-size:12px;color:#5c8a8a'>NOW &#8377;" .$row[10]."</p></div></a></div></li>";
    }
	echo "</ul>";
?>
</div>
