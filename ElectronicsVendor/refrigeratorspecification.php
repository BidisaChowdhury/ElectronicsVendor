...
?>
<nav>
	<img style="margin:15px;padding-left:150px;padding-top:20px;width:400px;height:600px" src="<?php echo $row[5] ?>">
<br>
<?php
		if($row[14]>0)
		{
			...
			echo "<td><a href='refrigeratorbuynow.php?model=$row[1]'><button style='background-color:#006600;color:#ffffff;width:260px;height:80px'> BUY NOW </button></a></td></tr></table>";
		}
		else
		{
...
<article>
	...
	<p style="color:#000033;font-size:28px;padding-left:423px"><strike>&#8377;<?php echo $row[12] ?></strike></p>
	<blink style=';padding-left:423px'> OFFER PRICE </blink>
	<p style="color:#000033;font-size:28px;padding-left:423px">&#8377;<?php echo $row[13] ?> </p>
	<br>
	<p style="color:#000000;font-size:22px">SPECIFICATION </p><hr>
	<?php
		echo "<table>";
		echo "<tr><td>Model Name </td><td>" .$row[1]. "</td></tr>";
		echo "<tr><td>Model No. </td><td>" .$row[2]. "</td></tr>";
		echo "<tr><td>Brand </td><td>" .$row[3]. "</td></tr>";
		echo "<tr><td>Type </td><td>" .$row[4]. "</td></tr>";
		echo "<tr><td>Refrigerator Type </td><td>" .$row[6]. "</td></tr>";
		echo "<tr><td>Capacity </td><td>" .$row[7]. "</td></tr>";
		echo "<tr><td>Door </td><td>" .$row[8]. "</td></tr>";
		echo "<tr><td>Star Rating </td><td>" .$row[9]. "</td></tr>";
		echo "<tr><td>Production Year </td><td>" .$row[10]. "</td></tr>";
		echo "<tr><td>Warranty </td><td>" .$row[11]. "</td></tr></table>";
